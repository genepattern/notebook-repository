...
# Copy static assets to the data_files_path directory (wish there were a better way to hand that)
...
c.JupyterHub.default_url = '/projects'
...
#c.JupyterHub.data_files_path = '/Users/tmtabor/opt/anaconda3/envs/notebook-repository/share/jupyterhub'
