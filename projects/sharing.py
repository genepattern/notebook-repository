...
from .hub import spawner_info, encode_username
...
class Share(Base):
    ...
    def dir_exists(self):
        return os.path.exists(os.path.join(Config.instance().USERS_PATH, encode_username(self.owner), self.dir))
        ...
        if full_metadata:
            ...
            if spawner:
                ...
                data['project'] = {
                    ...
                    'status': json.loads(spawner[1] if spawner[1] is not None else '')
            }
        return data
